    ...
    <section id="about" className="bg-[#F5F5F5] py-8">
      <div className="section-container">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p ref={descriptionRef} className=" mb-8 text-xs text-base sm:text-xs md:text-xl text-gray-600 leading-relaxed fade-up" style={{ marginBottom: '32px' }}>
          ...
          <a
            ...
            ref={buttonRef}
            className="mt-8 px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base border-2 border-black rounded-lg font-medium scale-up
